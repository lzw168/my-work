...
//-------------------------------------------------------------------------------------------------------------------------------------------------
+ (void)showText:(NSString *)status Interaction:(BOOL)Interaction Hide:(BOOL)hide
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
    [self shared].interaction = Interaction;
    [[self shared] hudMake:status image:nil spin:NO hide:hide];
}
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	//---------------------------------------------------------------------------------------------------------------------------------------------
	[self hudSize];
    if (image.hidden && !spin) {
        hud.frame = CGRectMake(hud.frame.origin.x, hud.frame.origin.y, hud.frame.size.width, hud.frame.size.height - 40);
        label.frame = CGRectMake(label.frame.origin.x, 22, label.frame.size.width, label.frame.size.height);
    }
