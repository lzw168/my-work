...
@interface SubStoreDetailViewController ()
...
@implementation SubStoreDetailViewController
...
- (void)section3UIWithCell:(UITableViewCell *)cell withCellHeight:(CGFloat)cellHeight withRow:(NSInteger)row
{
    ...
    location.text = [NSString stringWithFormat:@"%@",goods.location];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    switch (indexPath.section) {
        ...
        case 1:
        {
            ...
            NSLog(@"======333333%lu",(unsigned long)[self.shopsArr count]);
