            ...
            switch (indexPath.row)
        {
                ...
                switch (self.goodsOnSellsType)
            {
                case CheckGoodsOnSellsTypeLimitToFactory:
                {
                    ...
                    pricelab.text = [NSString stringWithFormat:@"￥%@个臭美币",self.goods.goodsNowPrice];
            ...
            case 1:
            {
                ...
                self.total = [self.goods.goodsNowPrice floatValue]* self.goodnum;
...
- (void)AddBtn
{
    ...
    float total = [self.goods.goodsNowPrice floatValue]* self.goodnum;
