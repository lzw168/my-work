//
//  GoodDetailTableViewController.m
//  BeautyWhere
//
...
@interface GoodDetailTableViewController ()
...
@implementation GoodDetailTableViewController
    ...
    switch (indexPath.section)
    {
            ...
            switch (indexPath.row)
        {
                ...
                case 1:
                   {
                       ...
                       [self.pic setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",GetAppDelegate.img_path, self.siglegoods.goodsImgLastComponentURL]] placeholderImage:[UIImage imageNamed:@"pic_2loading.png"]];
                       ...
                       pricelab.text = [NSString stringWithFormat:@"%@",self.siglegoods.name];
                    ...
                    switch (self.goodsOnSellsType)
                    {
                        case CheckGoodsOnSellsTypeLimitToFactory:
                        {
                            ...
                            pricelab.text = [NSString stringWithFormat:@"￥%@个臭美币",self.siglegoods.goods_price];
            ...
            case 3:
            {
                ...
                self.total = [self.siglegoods.goods_price floatValue]* self.goodnum;
            ...
            break;
        case 1:
            /*cell.textLabel.text = self.siglegoods.goodsContent;
...
- (void)pressedBuy
{
    ...
    else
    {
        ...
        NSLog(@"goodsOnSellsType===========%ld",(long)self.goodsOnSellsType);
        [HomePageNetwork checkGoodsOnSellOrNotWithGoodsID:self.activity_id withType:self.goodsOnSellsType withGoodsNum:[NSString stringWithFormat:@"%d",self.goodnum] withSuccessBlock:^(BOOL finished)
        {
            if (finished)
            {
                [ProgressHUD dismiss];
...
- (void)AddBtn
{
    ...
    float total = [self.siglegoods.goods_price floatValue]* self.goodnum;
